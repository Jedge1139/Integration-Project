...
// Cross Module References
	ZOMBIEGAME_API UClass* Z_Construct_UClass_AZombie_NoRegister();
	ZOMBIEGAME_API UClass* Z_Construct_UClass_AZombie();
...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AZombie_Statics::NewProp_ZombieMesh = { "ZombieMesh", nullptr, (EPropertyFlags)0x0010000000080009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AZombie, ZombieMesh), Z_Construct_UClass_USkeletalMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AZombie_Statics::NewProp_ZombieMesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AZombie_Statics::NewProp_ZombieMesh_MetaData)) };
	...
	IMPLEMENT_CLASS(AZombie, 4201962559);
	template<> ZOMBIEGAME_API UClass* StaticClass<AZombie>()
	{
		return AZombie::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AZombie(Z_Construct_UClass_AZombie, &AZombie::StaticClass, TEXT("/Script/ZombieGame"), TEXT("AZombie"), false, nullptr, nullptr, nullptr);
